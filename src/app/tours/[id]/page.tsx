...
import { FaUsers, FaCalendarAlt, FaUserTie, FaArrowLeft, FaMapMarkerAlt, FaMoneyBillWave, FaStar } from "react-icons/fa";
...
export default async function TourDetailPage(props: { params: { id: string } }) {
  ...
  // Función para mostrar salida/regreso como texto
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
        ...
        <div className="bg-black/20 backdrop-blur-sm border border-indigo-500/30 rounded-2xl p-6 md:p-8 shadow-inner shadow-indigo-500/10 transition-all hover:border-indigo-400/50 h-full">
          ...
          <div className="mt-8 pt-6 border-t border-indigo-700/50">
            <button className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-indigo-600/30 flex items-center justify-center gap-3">
              Reservar ahora
