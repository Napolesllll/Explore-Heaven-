    ...
    <div ref={containerRef} className="relative min-h-screen bg-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
        ...
        >
          ...
          >
            <span className="absolute -left-6 text-yellow-400 animate-pulse">&gt;</span>
            Descubre los destinos más increíbles del universo y vive experiencias que desafían los límites de la realidad
          </motion.p>
