...
import { FaCalendarAlt, FaUserAlt, FaEnvelope, FaRocket, FaCheckCircle, FaSpinner } from "react-icons/fa";
...
export default function TourDetail({ tour }: { tour: Tour }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.fecha || new Date(formData.fecha).getTime() < new Date().setHours(0, 0, 0, 0))
                ...
                <div className="space-y-5">
                        ...
                        >
                          {fechasDisponibles.includes(formData.fecha) ? (
                            <>
                              ...
                              <span className="text-cyan-400">Fecha disponible</span>
                            </>
                          ) : (
                            <>
                              <FaRocket className="text-purple-400" />
                              <span className="text-purple-400">Verificando disponibilidad...</span>
                            </>
                          )}
                        </motion.div>
                      )}
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-2">
                      {isLoading ? (
                        <>
                          <FaSpinner className="animate-spin" /> Procesando tu reserva...
                        </>
                      ) : (
