...
export default function AddGuiaForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      setModal({ isOpen: true, message: "Todos los campos son obligatorios", type: "error" });
      return;
    }
  ...
  return (
    <>
      <div className="min-h-screen w-full bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] p-4 flex flex-col items-center justify-center">
        <div className="w-full max-w-4xl">
          <div className="relative">
            {/* Efectos futuristas de fondo */}
            ...
            <form
              ...
              className="relative space-y-6 bg-[#0f172a]/70 backdrop-blur-xl border border-cyan-500/30 p-8 rounded-3xl shadow-2xl shadow-cyan-500/10 hover:shadow-cyan-500/20 transition-all duration-500"
            >
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center mb-6">
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full blur-lg opacity-30 animate-pulse"></div>
                ...
                <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 mb-2 tracking-wide">
                  Agregar un Nuevo Guía
                </h2>
                <p className="text-gray-400 text-sm max-w-md mx-auto">
                  Completa todos los campos para registrar un nuevo guía en el sistema
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="edad" className="block text-sm font-medium text-cyan-300 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="space-y-2">
                  <label htmlFor="cedula" className="block text-sm font-medium text-cyan-300 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="space-y-2 md:col-span-2">
                  <label htmlFor="celular" className="block text-sm font-medium text-cyan-300 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          >
            ...
            <div className="relative z-10 p-8 max-w-md">
              <div className="flex justify-center mb-6">
                <div className={`p-4 rounded-full ${modal.type === "success" ? "bg-cyan-500/20" : "bg-red-500/20"}`}>
                  <div className={`p-3 rounded-full ${modal.type === "success" ? "bg-cyan-500/30" : "bg-red-500/30"}`}>
                    {modal.type === "success" ? (
              ...
              <h3 className={`text-2xl font-bold text-center mb-3 ${modal.type === "success" ? "text-cyan-400" : "text-red-400"}`}>
