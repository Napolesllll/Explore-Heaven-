...
const testimonials = [
  {
    name: 'Sara Müller',
    location: 'Alemania',
    content: '¡Una experiencia increíble! Colombia me sorprendió con su calidez y belleza. El guía fue excelente y muy atento.',
  ...
  }, 
  {
    name: 'Marco Silva',
    location: 'Brasil',
    content: 'Los paisajes fueron espectaculares y el recorrido estuvo bien organizado. Sin duda lo recomiendo.',
  ...
  },
  {
    name: 'Emma Johnson',
    location: 'Canadá',
    content: 'Desde que reservé me sentí acompañada. El equipo fue muy profesional. ¡Gracias por esta aventura inolvidable!',
...
export default function TestimonialSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-900 to-black text-white px-4 relative overflow-hidden" id="testimonios">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <span className="block text-gray-300 mt-2 text-xl font-normal">De viajeros que vivieron Medellín</span>
        </motion.h2>
              ...
              >
                ...
                >
                  ...
                  <motion.div 
                    ...
                    animate={{
                      boxShadow: ["0 0 0px rgba(218, 165, 32, 0)", "0 0 15px rgba(218, 165, 32, 0.5)", "0 0 0px rgba(218, 165, 32, 0)"]
                    }}
                    transition={{
                      duration: 2,
                      repeat: Infinity
          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                animate={{
                  boxShadow: ["0 0 10px rgba(218, 165, 32, 0.3)", "0 0 20px rgba(218, 165, 32, 0.5)", "0 0 10px rgba(218, 165, 32, 0.3)"]
                }}
                transition={{
                  duration: 3,
                  repeat: Infinity
              ...
              <div className="p-4 bg-gradient-to-r from-yellow-600/10 to-transparent border-t border-yellow-500/20">
                <p className="text-yellow-300 text-center font-light text-sm tracking-widest">TESTIMONIO DE VIAJERO</p>
              </div>
            </motion.div>
          </motion.div>
        )}
