...
import { CheckCircle, Clock, MapPin, CalendarDays, Star, ChevronDown } from "lucide-react";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Explora nuestros tours exclusivos y vive una experiencia inolvidable. 
            Desde arte urbano en la Comuna 13 hasta museos históricos, tenemos el recorrido perfecto para ti.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 z-10 ${
                  isExpanded ? "bg-gradient-to-b from-black/90 to-black/80" : "bg-gradient-to-b from-black/80 to-black/60"
                }`} />
                ...
                <div className="relative z-20 p-6 min-h-[300px] flex flex-col justify-between">
                  ...
                  <div>
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="text-xl font-bold text-yellow-400">{tour.nombre}</h3>
                      ...
                      <div className="bg-gradient-to-r from-yellow-600 to-yellow-800 px-3 py-1 rounded-10">
                        <span className="text-white font-bold text-sm">{tour.precio}</span>
                      </div>
                    </div>
